...
export default function DashboardT() {
    ...
    // 🔥 Noto'g'ri route bo'lsa, asosiy sahifaga yo'naltirish
    useEffect(() => {
        if (!menu) {
            navigate("/dashboard-t/asosiy");
        }
    }, [menu, navigate]);
    ...
    return (
        <div className={`w-full h-screen flex bg-gray-100 dark:bg-gray-900`}>
            ...
            <div className="main w-5/6 h-full bg-white dark:bg-gray-800 flex items-center justify-center shadow-md rounded-l-xl">
                ...
                {menu==='asosiy'?<Tmain />:menu==="profil"?<ProfileT/>:null}
            </div>
        </div>
    );
}
